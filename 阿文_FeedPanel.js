    ...
    <div className="feedPanel">
      <div className="feedRow">
        <div className="feedField">
          <div className="sectionLabel">① 本篇照片（做正文素材，第一张默认当头图底图）</div>
          ...
          {images.length ? (
            ...
            <div className="feedNoImg">没传图也能写，头图会用 AI 配图兜底（可能较慢）。建议传 1-3 张你店里的真实照片。</div>
          )}
          {images.length ? (
      ...
      <div className="feedRow feedRow2">
        <div className="feedField">
          ...
          <input
            ...
            placeholder="例：我们为什么坚持每天现熬汤 / 一个老顾客8年的故事 / 行业观察：XX趋势"
            disabled={working}
          />
        </div>
