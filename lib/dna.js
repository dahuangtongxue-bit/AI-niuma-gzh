...
//  代运营管 N 个客户，切到哪个品牌，阿文就用哪个品牌的口径和调性干活。
// ============================================================================
'use client';

const KEY = 'awen-dnas';           // [{ key, dna }]
const CUR = 'awen-dna-current';    // 当前品牌 key

// 阿文的平台微调（随DNA一起拼进prompt）
export const PLATFORM_TONE = '公众号沉稳、可长可深，娓娓道来；比全局再稳重克制一点。';
